...
class BasePage:
    ...
    def wait_for_element_to_be_clickable(self, locator):
        ...
        try:
            return wait.until(EC.element_to_be_clickable(locator=locator))
        except (TimeoutException, WebDriverException, NoSuchElementException):
            try:
                self.scroll_to_top()
                return wait.until(EC.element_to_be_clickable(locator=locator))
    ...
    def wait_for_element_to_be_visible(self, locator):
        ...
        try:
            return wait.until(EC.visibility_of_element_located(locator=locator))
    ...
    def wait_for_invisibility_of_element(self, locator, wait_time=7):
        ...
        if wait.until(EC.invisibility_of_element_located(locator=locator)):
            return True
        else:
            return False
